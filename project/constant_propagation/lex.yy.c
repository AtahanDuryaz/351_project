...
YY_RULE_SETUP
#line 7 "lexx.l"
{ yylval.number = atoi(yytext); return INTEGER; }  // Return integer value
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 8 "lexx.l"
{ yylval.str = strdup(yytext); return IDENT; }  // Return identifier
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 9 "lexx.l"
